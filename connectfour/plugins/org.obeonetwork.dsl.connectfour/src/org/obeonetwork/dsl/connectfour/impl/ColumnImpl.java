 ...
 * </p>
 * <ul>
 *   <li>{@link org.obeonetwork.dsl.connectfour.impl.ColumnImpl#getCells <em>Cells</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnImpl extends MinimalEObjectImpl.Container implements Column {
	...
	protected EClass eStaticClass() {
		return ConnectfourPackage.Literals.COLUMN;
	}
	...
	public EList<Cell> getCells() {
		if (cells == null) {
			cells = new EObjectWithInverseResolvingEList<Cell>(Cell.class, this, ConnectfourPackage.COLUMN__CELLS, ConnectfourPackage.CELL__COLUMN);
		}
		return cells;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConnectfourPackage.COLUMN__CELLS:
