 ...
 * </p>
 * <ul>
 *   <li>{@link org.obeonetwork.dsl.connectfour.impl.LineImpl#getCells <em>Cells</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LineImpl extends MinimalEObjectImpl.Container implements Line {
	...
	protected EClass eStaticClass() {
		return ConnectfourPackage.Literals.LINE;
	}
	...
	public EList<Cell> getCells() {
		if (cells == null) {
			cells = new EObjectWithInverseResolvingEList<Cell>(Cell.class, this, ConnectfourPackage.LINE__CELLS, ConnectfourPackage.CELL__LINE);
		}
		return cells;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConnectfourPackage.LINE__CELLS:
