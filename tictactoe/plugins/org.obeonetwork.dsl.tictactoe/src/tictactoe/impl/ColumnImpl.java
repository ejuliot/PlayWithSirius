 ...
 * </p>
 * <ul>
 *   <li>{@link tictactoe.impl.ColumnImpl#getCells <em>Cells</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnImpl extends MinimalEObjectImpl.Container implements Column {
	...
	protected EClass eStaticClass() {
		return TictactoePackage.Literals.COLUMN;
	}
	...
	public EList<Cell> getCells() {
		if (cells == null) {
			cells = new EObjectWithInverseResolvingEList<Cell>(Cell.class, this, TictactoePackage.COLUMN__CELLS, TictactoePackage.CELL__COLUMN);
		}
		return cells;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TictactoePackage.COLUMN__CELLS:
